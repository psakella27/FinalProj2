...
# ── Filter to hate-speech comments ────────────────────────────────────────────
...
# ── Targeted-alone vs co-targeted summary ─────────────────────────────────────
...
# ── Save outputs ──────────────────────────────────────────────────────────────
summary.to_csv("target_group_summary.csv", index=False)
word_rates.to_csv("word_rates_by_target.csv")

print("Saved: target_group_summary.csv")
print("Saved: word_rates_by_target.csv")
